...
install_python      =   "/home/administrator/server_updates/bash_scripts/install_python.sh"
...
check_services_ssh  =   "home/administrator/server_updates/bash_scripts/check_services_ssh.sh"
...
if "y" in prerequisites_y_n or "Y" in prerequisites_y_n:
    call([install_python, user, address, port, password])
...
call([check_services_ssh,user, address, port, password, check_services])
